...
class TestPoint:
    ...
    def test_newperimeter(self):
        assert self.f.newperimeter() == 0.0
...
class TestSegment:
    ...
    def test_newperimeter(self):
        assert self.f.newperimeter() == approx(1.0)
...
class TestPolygon:
    ...
    def test_newperimeter1(self):
        assert self.f.newperimeter() == approx(sqrt(2.0) + 2.0)

    #   добавление точки может его изменить
    def test_perimeter2(self):
        assert self.f.add(R2Point(1.0, 1.0)).perimeter() == approx(4.0)

    def test_newperimeter2(self):
        assert self.f.add(R2Point(1.0, 1.0)).newperimeter() == approx(4.0)
